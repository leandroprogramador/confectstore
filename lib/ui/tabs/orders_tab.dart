...
import 'package:confectstore/ui/tiles/order_tile.dart';
    ...
    if(UserModel.of(context).isLoggedIn()){
      ...
      return Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            Icon(Icons.list, size: 80.0, color: Theme.of(context).primaryColor),
            SizedBox(height: 16.0),
            Text("Faça o login para acompanhar seus pedidos!", style: TextStyle(fontSize: 20.0, fontWeight: FontWeight.bold), textAlign: TextAlign.center,),
            SizedBox(height: 16.0),
            RaisedButton(
